...
namespace Test
{
    internal class Asset3d
    {
        ...
        public void createTrapezoidHeadVertices(float x, float y, float z, float length)
        {
            Vector3 temp_vector;
        ...
        public void createTrapezoidBodyVertices(float x, float y, float z, float length)
        {
            Vector3 temp_vector;
        ...
        public void createLongBoxVertices(float x, float y, float z, float length)
        {
            Vector3 temp_vector;
        ...
        public void createFlatBoxVertices(float x, float y, float z, float length)
        {
            Vector3 temp_vector;
        ...
        public void addChild(float x, float y, float z, float length)
        {
            ...
            newChild.createLongBoxVertices(x, y, z, length);
            Child.Add(newChild);
        }
    }
}